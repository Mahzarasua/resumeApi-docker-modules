...
// @Hidden
public class CommonJwtAuthenticationController {

    protected final CommonCustomAuthenticationManager authenticationManager;

    protected final CommonJwtTokenUtil jwtTokenUtil;

    protected final JwtRequestValidator validator;

    public CommonJwtAuthenticationController(
