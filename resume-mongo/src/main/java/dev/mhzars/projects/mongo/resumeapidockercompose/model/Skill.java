...
/**
 * Represents a professional skill entry within a resume, stored as a subdocument in MongoDB.
 * Extends {@link CommonSkill} to inherit common skill fields and adds MongoDB-specific identifiers.
 *
 * <p>This class is used as a nested document within the {@link Resume} class to store information
 * about technical proficiencies, languages, or other relevant professional skills.
 *
 ...
 *
 * @see Resume The parent resume document containing skill entries
 * @see CommonSkill Base class containing common skill fields
...
public class Skill extends CommonSkill {
    /**
     * The unique identifier for the skill entry in MongoDB. Uses MongoDB's native {@link ObjectId}
     * type with proper BSON mapping.
     *
