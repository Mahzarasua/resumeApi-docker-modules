...
import static dev.mhzars.projects.commons.resumeapidockercompose.CommonTestUtils.setChildTables;
...
class ResumeValidatorTest {
    ...
    @Test
    void validate() {
        CommonResumeRequest request =
                CommonTestUtils.manufacturedCustomPojo(CommonResumeRequest.class);
