...
public class CommonResumeController {
    private final ResumeService service;

    public CommonResumeController(ResumeService service) {
    ...
    public List<ResumeResponse> getResumes() throws JsonProcessingException {
    ...
    public ResumeIdResponse createResume(@RequestBody CommonResumeRequest request) {
    ...
    public ResumeIdResponse updateResume(
            @Parameter(name = "resumeId", required = true) @PathVariable("resumeId")
                    String resumeId,
            @RequestBody CommonResumeRequest request) {
