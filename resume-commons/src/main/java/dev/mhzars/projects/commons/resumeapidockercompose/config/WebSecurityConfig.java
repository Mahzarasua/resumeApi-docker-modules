...
public class WebSecurityConfig {
    private final CommonJwtAuthenticationEntryPoint jwtAuthenticationEntryPoint;
    private final CommonJwtRequestFilter jwtRequestFilter;
    private final CommonCustomAuthenticationManager customAuthenticationManager;
