...
@Slf4j
class CommonResumeControllerTest {

    private static CommonResumeController controller;
    ...
    void init() throws JsonProcessingException {
        ...
        controller = new CommonResumeController(service);
    }
    ...
    void givenValidRequest_whenCreateResume_thenSuccess() {
        CommonResumeRequest request = manufacturedPojo(CommonResumeRequest.class);
